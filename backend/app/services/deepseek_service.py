...
class DeepseekService:
    ...
    def identify_files_prompt(self, files):
        ...
        Format your response as JSON with keys frontend, backend and infra each with a respective array of file paths. ONLY RETURN FILES THAT ARE WORTH ANALZYING FURTHER
        """
    ...
    def get_file_analysis_prompt(self, files):
        ...
        - Code snippets demonstrating the fix (if applicable)
        - Relevant references or best practices
        ...
        [
          {
            ...
            "code_snippets": {
              "before": "const apiKey = '1234567890';",
              "after": "const apiKey = process.env.API_KEY;"
            },
            "references": ["https://owasp.org/www-community/vulnerabilities/Hard_coded_password"]
          }
        ]
        ```
...
"""
    ...
    prompt = deepseek.get_file_analysis_prompt(file_contents)
